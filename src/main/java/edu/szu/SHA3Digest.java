...
//            displayIntermediateValues.displayStateAs64bitWords(3, "After iota", state);
    ...
    public static String StringDigest(int bits, String expected){
    ...
    public static String rolling(InputStream fis) throws IOException {
        ...
        digest.doFinal(hash, 0);
        return SHA3Digest.bytesToHexString(hash);
    }
    ...
    public static void main(String args[]) {
        String s_pwd = SHA3Digest.StringDigest(256,  "12345678").toLowerCase();
        String s_pwdAndNo = SHA3Digest.StringDigest(256, s_pwd + "1");
        System.out.println(s_pwdAndNo.toUpperCase());
    }
